...
// Se cambia el contenido de cada celda con los datos del participante
cell1.textContent = libro.getElementsByTagName("titulo")[0].textContent;
cell2.textContent = libro.getElementsByTagName("autor")[0].textContent;
cell3.textContent = libro.getElementsByTagName("anio")[0].textContent;
cell4.textContent = libro.getElementsByTagName("precio")[0].textContent;
}
}
}
// llama a la función
...
var filtroAnio = filtro.value
for (var i = 0; i < libros.length; i++) {
var libro = libros[i];
var anio = libro.getElementsByTagName("anio")[0].textContent;
// Si año filtro egual a año libro
